...
function About() {
  return (
    <div id="about-us" className="py-5 bg-white">
        ...
        <div className="row">
          ...
          <div className="col-md-6 col-sm-12">
            <p>
              ...
              with lifelong memories. Whether you're venturing deep into the
              heart of the savannah, trekking through lush rainforests, or
              witnessing breathtaking sunsets over vast landscapes, we promise
            ...
            <p>
              ...
              itineraries that cater to your unique preferences, whether you're
              a solo traveler seeking tranquility, a couple looking for romance,
              or a family eager for shared discoveries.
            </p>
            <p>
